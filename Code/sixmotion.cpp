...
void parse_raw(_sixmotion_hidraw &raw, _sixmotion &sixm) {
    ...
    sixm.R1 = (float)raw.BTN_R1_VALUE;
    sixm.R2 = (float)raw.BTN_R2_VALUE;

    sixm.BTN_X = (uint8_t)raw.BTN_X;
    ...
    //printf("%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d \n",raw.res0,raw.res1,raw.res2,raw.res3,raw.res4,raw.res5,raw.res6,raw.res7,raw.BTN_X,raw.res9,raw.res10,raw.res11,raw.res12,raw.res13,raw.res14,raw.res15,raw.res16,raw.res17,raw.res18);
